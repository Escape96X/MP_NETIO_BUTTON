...
SYNC_TIMEOUT = 0.2                    # timeout for syncing with bootloader    default = 0.1   MARTINTUNE
...
DEFAULT_SERIAL_WRITE_TIMEOUT = 20     # timeout for serial port write   default = 10    MARTINTUNE
...
class ESPLoader(object):
    ...
    def _connect_attempt(self, mode='default_reset', esp32r0_delay=False):
        ...
        if mode != 'no_reset':
            ...
            time.sleep(0.05)
                # self._setDTR(False)  # IO0=HIGH, done    MARTINTUNE
...
def main(custom_commandline=None):
    ...
    if operation_args[0] == 'esp':  # operation function takes an ESPLoader connection object
        ...
        esp._setDTR(False)  # IO0=HIGH    MARTINTUNE
        esp._port.close()
