...
% MĚŘENÍ
	...
	\podkapitola{Kontinuální režim}
		...
		\podpodkapitola{WiFi připojení}
			...
			% \tabulka{WiFi porovnání}{Porovnání hodnot naměřené připojením k WiFi}
			% 	{Dynamické & Statické & Zabezpečení\\}
			% 	{5.3385 & 3.589 & 4.733\\
			% 	5.3445 & 3.583 & 4.733\\
			% 	3.619 & 3.631 & 4.733\\
			% 	5.333 & 3.481 & 4.733\\
		...
		Cílem měření je zjistit čas odesílání HTTP requestu a následné odpovězení zásuvky NETIO
